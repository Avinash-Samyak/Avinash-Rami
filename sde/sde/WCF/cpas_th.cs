                    ...
                    using (sdeEntities entities = new sdeEntities())
                    {
                            ...
                            try
                            {
                                ...
                                if (conItemGroup.Count() > 0)
                                {
                                    ...
                                    var insertTask2 = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH SALES WITH PRICE INST', 'CPASSTOCKPOSTING.SPL_SP_ID." + refNo + '.' + con.location_id + "', '" + gjob_id.ToString() + "'," +
                        ...
                        if (status == true)
                        {
                            if (rowCount > 0)
                            {
                                ...
                                "rn_updatedDate = '" + convertDateToString(DateTime.Now) + "' where rn_sche_transactionType = 'CPAS-TH SALES WITH PRICE INST' " +
                    ...
                    using (sdeEntities entities = new sdeEntities())
                    {
                        ...
                        foreach (var con in cpasSalesGroup)
                        {
                            try
                            {
                                ...
                                if (conItemGroup.Count() > 0)
                                {
                                    ...
                                    var insertTask2 = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH SALES WITH PRICE CAD', 'CPASSTOCKPOSTING.SPL_SP_ID." + refNo + '.' + con.location_id + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','')";
                        ...
                        if (status == true)
                        {
                            if (rowCount > 0)
                            {
                                ...
                                var updateRequestNetsuite = "update requestnetsuite set rn_jobID='" + jobID + "'," +
                                "rn_updatedDate = '" + convertDateToString(DateTime.Now) + "' where rn_sche_transactionType = 'CPAS-TH SALES WITH PRICE CAD' " +
                                "and rn_rangeTo = '" + convertDateToString(rangeTo) + "'";
                    ...
                    using (sdeEntities entities = new sdeEntities())
                    {
                        ...
                        foreach (var con in cpasSalesGroup)
                        {
                            try
                            {
                                ...
                                if (conItemGroup.Count() > 0)
                                {
                                    ...
                                    var insertTask2 = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH SALES UNSHIP', 'CPASDATAPOSTING.SPL_SP_ID." + refNo + '.' + con.location_id + '.' + con.tranType + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','')";
                        ...
                        if (status == true)
                        {
                            if (rowCount > 0)
                            {
                                ...
                                var updateRequestNetsuite = "update requestnetsuite set rn_jobID='" + jobID + "'," +
                                "rn_updatedDate = '" + convertDateToString(DateTime.Now) + "' where rn_sche_transactionType = 'CPAS-TH SALES UNSHIP' " +
                                "and rn_rangeTo = '" + convertDateToString(rangeTo) + "'";
                    ...
                    using (sdeEntities entities = new sdeEntities())
                    {
                        ...
                        foreach (var con in cpasSalesGroup)
                        {
                            try
                            {
                                ...
                                if (conItemGroup.Count() > 0)
                                {
                                    ...
                                    var insertTask2 = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH CASH SALES', 'CPASSTOCKPOSTING.SPL_SP_ID." + refNo + '.' + con.location_id + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','')";
                        ...
                        if (status == true)
                        {
                            if (rowCount > 0)
                            {
                                ...
                                var updateRequestNetsuite = "update requestnetsuite set rn_jobID='" + jobID + "'," +
                                "rn_updatedDate = '" + convertDateToString(DateTime.Now) + "' where rn_sche_transactionType = 'CPAS-TH CASH SALES' " +
                                "and rn_rangeTo = '" + convertDateToString(rangeTo) + "'";
                            ...
                            try
                            {
                                ...
                                if ((totalCommitinNS - Double.Parse(totalQtyinSDE.ToString()) == 1) || (totalCommitinNS - Double.Parse(totalQtyinSDE.ToString()) == 0))
                                {
                                    ...
                                    if (count1 >= 1)
                                    {
                                        ...
                                        "rnt_seqNO, rnt_nsInternalId, rnt_createdFromInternalID) values ('ADD', 'CPAS-TH FULFILLMENT', 'CPAS_SALESTRANSACTION.recID." + so.cst_recID.ToString() + "', '" + gjob_id.ToString() + "'," +
                        ...
                        if (status == true)
                        {
                            if (rowCount > 0)
                            {
                                ...
                                if ((jobID != null) && (jobID.StartsWith("ASYNC") == true))
                                {
                                    ...
                                    var updateRequestNetsuite = "update requestnetsuite set rn_jobID='" + jobID + "'," +
                                    "rn_updatedDate = '" + convertDateToString(DateTime.Now) + "' where rn_sche_transactionType = 'CPAS-TH FULFILLMENT' " +
                                    "and rn_rangeTo = '" + convertDateToString(rangeTo) + "'";
                            ...
                            try
                            {
                                ...
                                if (inv2 != null)
                                {
                                    ...
                                    if (inv2.itemList != null)
                                    {
                                        ...
                                        var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                            "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH INVOICE', 'CPASINVOICECREATION.SOINTERNALID." + i.cst_soInternalID + "', '" + gjob_id.ToString() + "'," +
                        ...
                        foreach (var q1 in grpReturn)
                        {
                            try
                            {
                                ...
                                if (raInvItem.Count() > 0)
                                {
                                    ...
                                    var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH RETURN AUTHORIZATION INST RETN', 'CPASSTOCKPOSTING.SPL_SP_ID." + q1.id + '.' + q1.location_id + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','')";
                                    ...
                                    var insSalesTrx = "insert into cpas_otherstransaction (cot_refNo, cot_invDate, cot_seqNo, cot_trxType, cot_invInternalID, " +
                                        ...
                                        "values ('CPASDATAPOSTING." + q1.memo + '.' + q1.salesPostingCat + '.' + q1.location_name + "', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "', 'CPAS-TH RETURN AUTHORIZATION INST RETN', " +
                                ...
                                //        "values ('CPASSTOCKPOSTING.SALESPOSTINGCAT." + q1.salesPostingCat + '.' + q1.location_id + "', '" + convertDateToString(DateTime.Now) + "', '', 'CPAS-TH RETURN AUTHORIZATION INST RETN', " +
                        ...
                        foreach (var q1 in grpReturn)
                        {
                            try
                            {
                                ...
                                if (raInvItem.Count() > 0)
                                {
                                    ...
                                    var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH RETURN INST RETN SUSPEND', 'CPASSTOCKPOSTING.SPL_SP_ID." + q1.id + '.' + q1.location_id + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','')";
                                    ...
                                    var insSalesTrx = "insert into cpas_otherstransaction (cot_refNo, cot_invDate, cot_seqNo, cot_trxType, cot_invInternalID, " +
                                        "cot_trxProgressStatus,cot_subsidiary,cot_subsidiaryInternalID,cot_salesType,cot_postingdate, cot_ml_location_internalID) " +
                                        "values ('CPASDATAPOSTING." + q1.memo + '.' + q1.salesPostingCat + '.' + q1.location_name + "', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "', 'CPAS-TH RETURN INST RETN SUSPEND', " +
                                        "'" + refInternalID + "','" + gjob_id.ToString() + "','" + q1.subsidiaryName + "','" + q1.subsidiaryInternalID + "','" + trxTypeVal + "','" + convertDateToString(_postDate) + "','" + q1.location_id + "')";
                        ...
                        foreach (var q1 in grpReturn)
                        {
                            try
                            {
                                ...
                                if (raInvItem.Count() > 0)
                                {
                                    ...
                                    var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH RETURN AUTHORIZATION INST RNCO', 'CPASSTOCKPOSTING.SPL_SP_ID." + q1.id + '.' + q1.location_id + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','')";
                                    ...
                                    var insSalesTrx = "insert into cpas_otherstransaction (cot_refNo, cot_invDate, cot_seqNo, cot_trxType, cot_invInternalID, " +
                                        "cot_trxProgressStatus,cot_subsidiary,cot_subsidiaryInternalID,cot_salesType,cot_postingdate , cot_ml_location_internalID) " +
                                        "values ('CPASDATAPOSTING." + q1.memo + '.' + q1.salesPostingCat + '.' + q1.location_name + "', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "', 'CPAS-TH RETURN AUTHORIZATION INST RNCO', " +
                                        "'" + refInternalID + "','" + gjob_id.ToString() + "','" + q1.subsidiaryName + "','" + q1.subsidiaryInternalID + "','" + trxTypeVal + "','" + convertDateToString(_postDate) + "','" + q1.location_id + "')";
                        ...
                        foreach (var q1 in grpReturn)
                        {
                            try
                            {
                                ...
                                if (raInvItem.Count() > 0)
                                {
                                    ...
                                    var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH RETURN INST RNCO SUSPEND', 'CPASSTOCKPOSTING.SPL_SP_ID." + q1.id + '.' + q1.location_id + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','')";
                                    ...
                                    var insSalesTrx = "insert into cpas_otherstransaction (cot_refNo, cot_invDate, cot_seqNo, cot_trxType, cot_invInternalID, " +
                                        "cot_trxProgressStatus,cot_subsidiary,cot_subsidiaryInternalID,cot_salesType,cot_postingdate, cot_ml_location_internalID) " +
                                        "values ('CPASDATAPOSTING." + q1.memo + '.' + q1.salesPostingCat + '.' + q1.location_name + "', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "', 'CPAS-TH RETURN INST RNCO SUSPEND', " +
                                        "'" + refInternalID + "','" + gjob_id.ToString() + "','" + q1.subsidiaryName + "','" + q1.subsidiaryInternalID + "','" + trxTypeVal + "','" + convertDateToString(_postDate) + "','" + q1.location_id + "')";
                                ...
                                //    var insSalesTrx = "insert into cpas_otherstransaction_error (cot_refNo, cot_invDate, cot_seqNo, cot_trxType, cot_invInternalID, " +
                                //        "cot_trxProgressStatus,cot_subsidiary,cot_subsidiaryInternalID,cot_salesType) " +
                                //        "values ('CPASSTOCKPOSTING.SALESPOSTINGCAT." + q1.salesPostingCat + '.' + q1.location_id + "', '" + convertDateToString(DateTime.Now) + "', '', 'CPAS-TH RETURN INST RNCO SUSPEND', " +
                                //        "'" + refInternalID + "', '', '" + q1.subsidiaryName + "', '" + q1.subsidiaryInternalID + "', '" + trxTypeVal + "')";
                                //    this.DataFromNetsuiteLog.Debug("CPASReturnAuthorizeInstRncoSuspend: " + insSalesTrx);
                                //    entities.Database.ExecuteSqlCommand(insSalesTrx);
                                //}
                        ...
                        foreach (var q1 in grpReturn)
                        {
                            try
                            {
                                ...
                                if (raInvItem.Count() > 0)
                                {
                                    ...
                                    var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH RETURN AUTHORIZATION CAD', 'CPASSTOCKPOSTING.SPL_SP_ID." + q1.id + '.' + q1.location_id + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','')";
                                    ...
                                    var insSalesTrx = "insert into cpas_otherstransaction (cot_refNo, cot_invDate, cot_seqNo, cot_trxType, cot_invInternalID, " +
                                        "cot_trxProgressStatus,cot_subsidiary,cot_subsidiaryInternalID,cot_salesType,cot_postingdate, cot_ml_location_internalID) " +
                                        "values ('CPASDATAPOSTING." + q1.memo + '.' + q1.salesPostingCat + '.' + q1.location_name + "', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "', 'CPAS-TH RETURN AUTHORIZATION CAD', " +
                                        "'" + refInternalID + "','" + gjob_id.ToString() + "','" + q1.subsidiaryName + "','" + q1.subsidiaryInternalID + "','" + trxTypeVal + "','" + convertDateToString(_postDate) + "','" + q1.location_id + "')";
                        ...
                        foreach (var q1 in grpReturn)
                        {
                            try
                            {
                                ...
                                if (raInvItem.Count() > 0)
                                {
                                    ...
                                    var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH RETURN AUTHORIZATION CASH SALES', 'CPASSTOCKPOSTING.SPL_SP_ID." + q1.id + '.' + q1.location_id + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','')";
                                    ...
                                    var insSalesTrx = "insert into cpas_otherstransaction (cot_refNo, cot_invDate, cot_seqNo, cot_trxType, cot_invInternalID, " +
                                        "cot_trxProgressStatus,cot_subsidiary,cot_subsidiaryInternalID,cot_salesType,cot_postingdate, cot_ml_location_internalID) " +
                                        "values ('CPASDATAPOSTING." + q1.memo + '.' + q1.salesPostingCat + '.' + q1.location_name + "', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "', 'CPAS-TH RETURN AUTHORIZATION CASH SALES', " +
                                        "'" + refInternalID + "','" + gjob_id.ToString() + "','" + q1.subsidiaryName + "','" + q1.subsidiaryInternalID + "','" + trxTypeVal + "','" + convertDateToString(_postDate) + "','" + q1.location_id + "')";
                            ...
                            try
                            {
                                ...
                                if (ir1 != null)
                                {
                                    ...
                                    if (iril1.item.Count() > 0)
                                    {
                                        ...
                                        var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                            "rnt_seqNO,rnt_createdFromInternalID) values ('ADD', 'CPAS-TH RETURN AUTHORIZE ITEMS RECEIPT', '" + refNo + "', '" + gjob_id.ToString() + "'," +
                        ...
                        if (status == true)
                        {
                            if (rowCount > 0)
                            {
                                ...
                                if ((jobID != null) && (jobID.StartsWith("ASYNC") == true))
                                {
                                    ...
                                    var updateRequestNetsuite = "update requestnetsuite set rn_jobID='" + jobID + "'," +
                                        "rn_updatedDate = '" + convertDateToString(DateTime.Now) + "' where rn_sche_transactionType = 'CPAS-TH RETURN AUTHORIZE ITEMS RECEIPT' " +
                                        "and rn_rangeTo = '" + convertDateToString(rangeTo) + "'";
            ...
            using (TransactionScope scope1 = new TransactionScope())
            {
                ...
                if (loginStatus == true)
                {
                    ...
                    using (sdeEntities entities = new sdeEntities())
                    {
                        ...
                        //            var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                        //                "rnt_seqNO, rnt_createdFromInternalID) values ('ADD', 'CPAS-TH RETURN AUTHORIZE CREDIT MEMO', '" + refNo + "', '" + gjob_id.ToString() + "'," +
                        ...
                        foreach (var i in qFilterMono)
                        {
                            try
                            {
                                ...
                                if (i.payment > 0)
                                {
                                    ...
                                    var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO, rnt_createdFromInternalID) values ('ADD', 'CPAS-TH PAYMENT INST', '" + refNo + "', '" + gjob_id.ToString() + "'," +
                            ...
                            if (status == true)
                            {
                                if (rowCount > 0)
                                {
                                    ...
                                    if ((jobID != null) && (jobID.StartsWith("ASYNC") == true))
                                    {
                                        ...
                                        timeOutInd = "3";
                                        var updateRequestNetsuite = "update requestnetsuite set rn_jobID = '" + jobID + "'," +
                                        "rn_updatedDate = '" + convertDateToString(DateTime.Now) + "' where rn_sche_transactionType = 'CPAS-TH PAYMENT INST' and rn_id = '" + rn_id + "' ";
                        ...
                        foreach (var i in qFilterMono)
                        {
                            try
                            {
                                ...
                                if (i.payment > 0)
                                {
                                    ...
                                    String refNo = "NETSUITE_PAYMENT.SALESPOSTINGCAT." + i.salesPostingCat + "." + convertDateToString(rangeFrom) + "-" + convertDateToString(rangeTo);
                                    var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO, rnt_createdFromInternalID) values ('ADD', 'CPAS-TH PAYMENT CAD', '" + refNo + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','" + refInternalID + "')";
                            ...
                            if (status == true)
                            {
                                if (rowCount > 0)
                                {
                                    ...
                                    if ((jobID != null) && (jobID.StartsWith("ASYNC") == true))
                                    {
                                        ...
                                        var updateRequestNetsuite = "update requestnetsuite set rn_jobID = '" + jobID + "'," +
                                        "rn_updatedDate = '" + convertDateToString(DateTime.Now) + "' where rn_sche_transactionType = 'CPAS-TH PAYMENT CAD' and rn_id = '" + rn_id + "' ";
                        ...
                        foreach (var i in qFilterMono)
                        {
                            try
                            {
                                if (i.payment > 0)
                                {
                                    ...
                                    String refNo = "NETSUITE_PAYMENT.SALESPOSTINGCAT." + i.salesPostingCat + "." + convertDateToString(rangeFrom) + "-" + convertDateToString(rangeTo);
                                    var insertTask = "insert into requestnetsuite_task (rnt_task, rnt_description, rnt_refNO, rnt_jobID, rnt_status, rnt_createdDate, " +
                                        "rnt_seqNO, rnt_createdFromInternalID) values ('ADD', 'CPAS-TH PAYMENT COD', '" + refNo + "', '" + gjob_id.ToString() + "'," +
                                        "'START', '" + convertDateToString(DateTime.Now) + "', '" + rowCount + "','')";
                            ...
                            if (status == true)
                            {
                                if (rowCount > 0)
                                {
                                    ...
                                    if ((jobID != null) && (jobID.StartsWith("ASYNC") == true))
                                    {
                                        ...
                                        var updateRequestNetsuite = "update requestnetsuite set rn_jobID = '" + jobID + "'," +
                                        "rn_updatedDate = '" + convertDateToString(DateTime.Now) + "' where rn_sche_transactionType = 'CPAS-TH PAYMENT COD' and rn_id = '" + rn_id + "' ";
