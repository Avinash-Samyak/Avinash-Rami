    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Index(LoginModel model, string returnUrl)
        {
            if (ModelState.IsValid && WebSecurity.Login(model.UserName, model.Password, persistCookie: model.RememberMe))
            {
                ...
                if (mbr.ValidateLogin(model.UserName, model.Password))
                {
            ...
            //TempData["ErrorMessage"] = "Login data is incorrect!";
        ...
        public ActionResult ExternalLoginCallback(string returnUrl)
        {
            ...
            if (OAuthWebSecurity.Login(result.Provider, result.ProviderUserId, createPersistentCookie: false))
            {
                //return RedirectToLocal(returnUrl);
                MySqlMembership mbr = new MySqlMembership();
                if (mbr.ValidateOAuthLogin(User.Identity.Name))
                {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (UsersContext db = new UsersContext())
                {
                    ...
                    if (user == null)
                    {
                        ...
                        MySqlMembership mbr = new MySqlMembership();
                        if (mbr.ValidateOAuthLogin(model.UserName))
                        {
                            FormsAuthentication.SetAuthCookie(model.UserName, false);
                            TempData["Message"] = model.UserName;
                            return RedirectToLocal(returnUrl);
