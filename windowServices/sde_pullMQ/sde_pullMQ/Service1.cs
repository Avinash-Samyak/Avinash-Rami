...
namespace sde_pullMQ
{
    public partial class Service1 : ServiceBase
    {
        ...
        {
            WCFsde.Service1 obj = new WCFsde.Service1();
            string path = @"C:\inetpub\wwwroot\sde_publish\windowServices\logger\start" + "-pullMQ.log";
            string path2 = @"C:\inetpub\wwwroot\sde_publish\windowServices\logger\" + DateTime.Now.ToString("yyyyMMdd") + "-pullMQ.txt";
        ...
        {
            string path = @"C:\inetpub\wwwroot\sde_publish\windowServices\logger\" + DateTime.Now.ToString("yyyyMMdd") + "-pullMQ.txt";
            //if (!File.Exists(path))
            //{
            //    File.Create(path);
            //}
